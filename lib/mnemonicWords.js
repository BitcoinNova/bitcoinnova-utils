...
Object.keys(words).forEach((lang) => {
  if (!words[lang].prefixLength || words[lang].prefixLength === 0) return

  const prefixLength = words[lang].prefixLength

  words[lang].trunc_words = []

  for (var i = 0; i < words[lang].words.length; ++i) {
    words[lang].trunc_words.push(words[lang].words[i].slice(0, prefixLength))
  }
})
