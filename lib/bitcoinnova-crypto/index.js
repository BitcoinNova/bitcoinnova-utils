...
/**
 * Module of Bitcoin Nova Cryptographic Methods
 * @module Crypto
 * @class
 */
class Crypto {
...
function loadBrowserWASM () {
  ...
  try {
    const Self = window.BitcoinNovaCrypto()
...
function loadNativeAddon () {
  try {
    const Self = require('bitcoinnova-crypto')
...
function loadNativeJS () {
  try {
    const Self = require('./bitcoinnova-crypto.js')()
...
function loadWASMJS () {
  ...
  try {
    const Self = require('./bitcoinnova-crypto-wasm.js')()
