// Copyright (c) 2018-2019, The Bitcoin Nova Developers
//
...
const BitcoinNovaCrypto = new Crypto()
const BitcoinNovaUtils = require('../').CryptoNote
const cnUtil = new BitcoinNovaUtils(require('../config.json'))

console.log('Using Crypto: %s', BitcoinNovaCrypto.type)
...
describe('Wallets', () => {
  ...
  const testAddress = 'ED4cr5x8eav2UwcFNSTcvDNcXHrvf8prE4Fe3HEysJwmSkR29NHQvA4Zbh3rkGEFm9jGfdVUn6wW6fUzgTKhZ4uqHXDi4uF'
  const testAddressRaw = '4ef71e440f9a5aab08dbdab0f4f36bba813660a0600f109b1371dc53be33f23c99f0ba225065e1b9c2e43165b3e41f10fcb768853126dfa7e612a3df2deb3324926f5d0d2a'
  ...
  describe('Message Signing', () => {
    it('sign a string message', () => {
      const signature = cnUtil.signMessage('this is a test message', 'EBWDmPcno5maMEBoMyCZMQK34MFMKjsKRBJKJawK25gdVnm3EKWZ7Wd89jqZGPewSHJqgm8N7WR89jRQjr4rGMFhGFf94xM', '9e239c214ad2eaee1fa598034a223b499df34ccce89b84183c13492414c9ce0f')
      assert((signature))
    })

    it('sign an object-based message', () => {
      const signature = cnUtil.signMessage({ mac: 'deadbeef', amount: 10 }, 'EBWDmPcno5maMEBoMyCZMQK34MFMKjsKRBJKJawK25gdVnm3EKWZ7Wd89jqZGPewSHJqgm8N7WR89jRQjr4rGMFhGFf94xM', '9e239c214ad2eaee1fa598034a223b499df34ccce89b84183c13492414c9ce0f')
      assert((signature))
    })

    it('verify signature - string message', () => {
      const isValid = cnUtil.verifyMessageSignature('this is a test message', 'EBWDmPcno5maMEBoMyCZMQK34MFMKjsKRBJKJawK25gdVnm3EKWZ7Wd89jqZGPewSHJqgm8N7WR89jRQjr4rGMFhGFf94xM', 'aca70bd60f083e7470742f8dfa3256697975d340c5a62a97d8777aa0992f930cb0cb45a52b3b3522272db5b5235feecb07dde5619476a813042cca2a0c9c030a')
      assert(isValid)
    })

    it('verify signature - object-based message', () => {
      const isValid = cnUtil.verifyMessageSignature({ mac: 'deadbeef', amount: 10 }, 'EBWDmPcno5maMEBoMyCZMQK34MFMKjsKRBJKJawK25gdVnm3EKWZ7Wd89jqZGPewSHJqgm8N7WR89jRQjr4rGMFhGFf94xM', 'c268de4909897ed8faffb999030198f3bc720bb96d4b4753f491f19a0eae640835fe8aa3da6a27b365ce35916dc2d36b75dc847a09af2ca72148678c470e990f')
      assert(isValid)
    })
  })
...
describe('Transactions', () => {
  ...
  describe('Transaction Creation', () => {
    it('generate a transaction', () => {
      const madeOutputs = cnUtil.createTransactionOutputs('ED4cr5x8eav2UwcFNSTcvDNcXHrvf8prE4Fe3HEysJwmSkR29NHQvA4Zbh3rkGEFm9jGfdVUn6wW6fUzgTKhZ4uqHXDi4uF', 90)
      const txPublicKey = '3b0cc2b066812e6b9fcc42a797dc3c723a7344b604fd4be0b22e06254ff57f94'
      const walletPrivateViewKey = '6968a0b8f744ec4b8cea5ec124a1b4bd1626a2e6f31e999f8adbab52c4dfa909'
      const walletPrivateSpendKey = 'd9d555a892a85f64916cae1a168bd3f7f400b6471c7b12b438b599601298210b'
      const walletPublicSpendKey = '854a637b2863af9e8e8216eb2382f3d16616b3ac3e53d0976fbd6f8da6c56418'
